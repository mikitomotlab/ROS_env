...
message(STATUS "myrobot: 1 messages, 6 services")

set(MSG_I_FLAGS "-Imyrobot:/home/miki/experiment/src/myrobot/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/miki/experiment/src/myrobot/srv/SetVelocity.srv" NAME_WE)
add_custom_target(_myrobot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myrobot" "/home/miki/experiment/src/myrobot/srv/SetVelocity.srv" ""
)

get_filename_component(_filename "/home/miki/experiment/src/myrobot/srv/SetVelocity2.srv" NAME_WE)
add_custom_target(_myrobot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myrobot" "/home/miki/experiment/src/myrobot/srv/SetVelocity2.srv" ""
)

get_filename_component(_filename "/home/miki/experiment/src/myrobot/srv/d_position.srv" NAME_WE)
add_custom_target(_myrobot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myrobot" "/home/miki/experiment/src/myrobot/srv/d_position.srv" ""
)

get_filename_component(_filename "/home/miki/experiment/src/myrobot/msg/dpos.msg" NAME_WE)
add_custom_target(_myrobot_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "myrobot" "/home/miki/experiment/src/myrobot/msg/dpos.msg" ""
)
...
_generate_msg_cpp(myrobot
  "/home/miki/experiment/src/myrobot/msg/dpos.msg"
  "${MSG_I_FLAGS}"
  ""
