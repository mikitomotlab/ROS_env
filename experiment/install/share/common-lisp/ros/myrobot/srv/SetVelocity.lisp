...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrobot-srv:<SetVelocity-request> is deprecated: use myrobot-srv:SetVelocity-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetVelocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetVelocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrobot-srv:<SetVelocity-response> is deprecated: use myrobot-srv:SetVelocity-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SetVelocity-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot-srv:success-val is deprecated.  Use myrobot-srv:success instead.")
  (success m))
